...
--     (nextval('offer_sequence'), 'I will fix your car', 'Fixing Car', 136, 3, 2, 3, 3),
--     (nextval('offer_sequence'), 'Cleaning bedrooms living room etc.', 'Clean House', 99, 3, 2, 3, 5),
--     (nextval('offer_sequence'), 'Mow the lawn', 'Mow the lawn', 50, 3, 2, 3, 1),
--     (nextval('offer_sequence'), 'Write a letter', 'Write a letter', 60, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Write a poem', 'Write poems', 60, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Cook for an occasion', 'Cook for an occasion', 200, 3, 2, 3, 6),
--     (nextval('offer_sequence'), 'Fix ceiling', 'Fix ceiling', 163, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Change your tires', 'Change your tires', 60, 3, 2, 3, 3),
--     (nextval('offer_sequence'), 'Teach you math', 'Teach you math', 80, 3, 2, 3, 4),
--     (nextval('offer_sequence'), 'Paint your walls', 'Paint your walls', 130, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Take care of your kids', 'Take care of your kids', 100, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Drive you to a location', 'Drive you to a location', 40, 3, 2, 3, 7),
--     (nextval('offer_sequence'), 'Deliver groceries to you house', 'Deliver groceries to you house', 30, 3, 2, 3, 6),
--     (nextval('offer_sequence'), 'Fix broken sink', 'Fix broken sink', 80, 3, 2, 3, 1);
